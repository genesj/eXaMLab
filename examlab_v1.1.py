...
############################################################################################################################################################
## Logging - Cross-Platform (macOS & Windows)
## Thanks to Josh Manders for this bit
############################################################################################################################################################
...
############################################################################################################################################################
##MoodleXMLBuilderApp
##In order, it initializes the application, sets up the user interface,
...
##This initializes the user interface.
    ...
    def setup_ui(self):
        try:
##This whole section sets up the user interface. The method validate_points is used to stop users from entering anything other than numbers into the points field. 
...
##
##This next section is the dropdown for selecting the type of question to add. The options are Multiple Choice, True/False, Short Answer, and Essay.
##The dropdown is handled like an OptionMenu, but it's actually a ComboBox.
##This section also sets up the various input fields for the different types of questions.
            ...
            # Adjust row weight for listbox to stretch
